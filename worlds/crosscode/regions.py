...
region_packs: typing.Dict[str, RegionsData] = {
    ...
    "open": RegionsData(
        ...
        region_connections = [
            ...
            RegionConnection(region_from='openDLC_DungeonEntry', region_to='openDLC_DungeonGF_L', cond=[ItemCondition(item_name='Heat', amount=1), ItemCondition(item_name='Wave', amount=1)]),
